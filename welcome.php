...
<header>
	<div class="main">
		<ul>
			<li class="active"><a style="font-size: 25px" href="#"> Home</a></li>
	...
	<div class="quote">
		<p><br>" The measure of life is not its duration,but its donation "<br>
		Welcome to Donation Community</p>
		<img src="logobp.png" class="logo">
	</div>
	<div class="footer">
