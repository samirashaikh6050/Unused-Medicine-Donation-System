...
<header>
	<div class="main">
		<ul>
			...
			<li class="active"><a style="font-size: 22px" href="about.php"> About</a></li>
			<li><a style="font-size: 25px" href="reqform.php">Request</a></li>
			<li><a style="font-size: 25px" href="login.php">Donator</a></li>
			<li><a style="font-size: 25px" href="ngologin.php">NGO</a></li>
			<li><a style="font-size: 25px" href="adminlogin.php">Admin</a></li>
		</ul>
	</div>
		<div class="obj">
			<img src="capsule.png" class="med">
				<h1>Why medicine?</h1><br>
			<p style="font-size:22px">Our health is a fundamental part of being human. Without it, we have nothing.
			Report shows, nearly 2 billion people have no access to basic medicines, causing a cascade of preventable misery and suffering.
		</p>
	</div>

	<div class="vis">
		<img src="vision1.jpg" class="ourvision">
		<h1> Our Vision</h1><br>
		<p style="font-size:22px">
			Our website drives the future of healthcare by connecting people with surplus medications.Our system is built to ensure 
			compliance and provide full liability protection.
		</p>
 	</div>

 	<div class="join">
 		<img src="join2.jpg" class="joinus">
 		<h1> Join Us</h1><br>
 		<p style="font-size:22px">You can join us easily with different aspects to become a part of the impact. You can be a Donator, Volunteer, Executive, Pharmacist or any Non Governmental Organisations.
 		</p>
 	</div>
 	<div class="footer">
